              ...
              <div className="bg-black/50 rounded-2xl shadow-lg shadow-black/30 border border-white/10 p-8 backdrop-blur-xl">
                ...
                <div className="space-y-6">
                  ...
                  <motion.button
                    ...
                    className="w-full bg-black/30 backdrop-blur-xl hover:bg-black/40 disabled:bg-black/20 text-white font-semibold py-4 px-6 rounded-xl transition-all disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg shadow-black/25 border border-white/10"
                  >
                    {loading ? (
                      <>
                  ...
                  {(depositRef || message) && (
                    <motion.button
                      ...
                      onClick={resetForm}
                      className="w-full bg-white/5 backdrop-blur-sm hover:bg-white/10 border border-white/10 text-gray-300 hover:text-white font-medium py-3 px-6 rounded-xl transition-all flex items-center justify-center gap-2"
                    >
            ...
            >
              ...
              {depositRef && (
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="bg-black/50 rounded-2xl shadow-lg shadow-black/30 border border-white/10 p-6 backdrop-blur-xl"
                >
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-8 h-8 bg-black/40 border border-white/10 rounded-lg flex items-center justify-center">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
                      <div className="flex items-center justify-between">
                        ...
                        <motion.button
                          ...
                          className="ml-2 p-2 rounded-lg bg-black/40 border border-white/10 hover:bg-black/50 text-white transition-colors"
                        >
              ...
              {message && (
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="rounded-2xl shadow-lg shadow-black/30 border border-white/10 p-6 bg-black/50"
                >
